            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route('todos.index') }}" class="text-primary-600 hover:text-primary-800 font-medium">
                            Mulai sekarang →
                        </a>
                    </p>
                </div>
                            ...
                            <div class="space-y-3">
                                @foreach($todayTodos as $todo)
                                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 {{ $todo->isCompleted() ? 'line-through' : '' }}">
                                                {{ $todo->title }}
                                            </p>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="mt-4 text-center">
                            <a href="{{ route('todos.index') }}" class="text-primary-600 hover:text-primary-800 text-sm font-medium">
                                Lihat Semua Todo →
                            </a>
                        </div>
                    </div>
