...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('dashboard.mentor') }}" class="nav-link">Home</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{ route('dashboard.mentor') }}" class="brand-link">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashboard.mentor') }}"
                                class="nav-link {{ request()->routeIs('dashboard.mentor') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('mentor.courses') }}"
                                class="nav-link {{ request()->routeIs('mentor.courses') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('mentor.calendar') }}"
                                class="nav-link {{ request()->routeIs('mentor.calendar') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('mentor.reports') }}"
                                class="nav-link {{ request()->routeIs('mentor.reports') ? 'active' : '' }}">
